...
artifacts = []
targets = [wrap_path, summary_path] + [os.path.join(root, rel) for _, _, rel in gates]
for path in targets:
...
scorecard = {
    ...
    "checks": [
        {
            "name": "all_s4_gates_scorecards_present",
            "status": "PASS" if not missing else "FAIL",
            "details": "Scorecards verificados"
        },
        {
            "name": "all_s4_gates_passed",
            "status": "PASS" if decision == "GO" else "FAIL",
            "details": reason
        },
        {
            "name": "wrap_summary_present",
            "status": "PASS",
            "details": "docs/sprint_4_orr_summary.md"
        },
        {
            "name": "decision_consistent_with_gates",
            "status": "PASS",
            "details": decision
        }
    ],
