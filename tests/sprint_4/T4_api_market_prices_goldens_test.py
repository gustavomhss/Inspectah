...
FIXTURES_DIR = ROOT / "fixtures" / "sprint_4" / "fontes_p0" / "api_market_prices"
GOLDENS_DIR = ROOT / "goldens" / "sprint_4" / "fontes_p0" / "api_market_prices"
RESULTS = []
...
def _dump():
    ...
    if target_dir:
        ...
        (path / "api_market_prices.json").write_text(json.dumps(RESULTS, indent=2, ensure_ascii=False))
...
def test_api_market_prices_goldens():
    try:
