...
> **Título:** Inspectah — Capítulo 4  
> **Versão:** v2  
> **Atualizado em:** 2025-11-15  
> **Resumo rápido:**  
> - Playbook operacional Gate-first com roteiro diário de 10 passos para o Codex/time.
> - Define papéis (PO, Planner, Codex, QA) e como montar superprompts a partir dos templates.
> - Instrui depuração por Gate, simultaneidade ORR e disciplina de evidências em out/.
