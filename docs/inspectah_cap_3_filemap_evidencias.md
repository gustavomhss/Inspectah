...
> **Título:** Inspectah — Capítulo 3  
> **Versão:** v2  
> **Atualizado em:** 2025-11-15  
> **Resumo rápido:**  
> - Define o filemap alvo orientado a Gates, separando docs, schema, configs, código e evidências.
> - Tabela Gate → artefatos (scripts, scorecards, bundles) garantindo evidence-by-design.
> - Convenções para scorecards JSON, manifests e caminhos únicos por tipo de ativo.
