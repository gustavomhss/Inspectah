...
- É preciso garantir que ele **não promete o que não existe** (ex.: ingestão automática em fontes oficiais) e recuse pedidos de validação de verdade/fato (isso pertence ao Debunker/futuras sprints).
