...
from app.ingestion.normalize_provider import normalize_social
...
def run(limit: int = 3, evidence_dir: Path | None = None) -> dict:
    ...
    profiles = [p for p in svc.list_profiles() if p.kind.value == "social"]
    ...
    for profile in profiles:
        ...
        out_path = evidence_dir / f"social_{profile.slug}.jsonl"
